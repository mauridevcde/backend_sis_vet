CREATE DATABASE  IF NOT EXISTS `sis_veterinaria` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `sis_veterinaria`;
...
CREATE TABLE `clientes` (
  ...
  CONSTRAINT `clientes_fk1` FOREIGN KEY (`id_mascota`) REFERENCES `mascotas` (`id_mascota`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci PACK_KEYS=0;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `consultas_clinicas`
--

LOCK TABLES `consultas_clinicas` WRITE;
/*!40000 ALTER TABLE `consultas_clinicas` DISABLE KEYS */;
/*!40000 ALTER TABLE `consultas_clinicas` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `registros_clinicos`
--

LOCK TABLES `registros_clinicos` WRITE;
/*!40000 ALTER TABLE `registros_clinicos` DISABLE KEYS */;
/*!40000 ALTER TABLE `registros_clinicos` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-05-24 21:34:13
